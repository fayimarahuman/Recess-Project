      ...
      <section className="about-content">
        ...
        <div className="team-grid">
          <div className="team-member">
            <img src="/images/team/sarah.jpg" alt="Sarah N." />
            <h3>Sarah N.</h3>
            <p>Founder & CEO</p>
          </div>
          <div className="team-member">
            <img src="/images/team/james.jpg" alt="James K." />
            <h3>James K.</h3>
            <p>Head of Operations</p>
          </div>
          <div className="team-member">
            <img src="/images/team/emma.jpg" alt="Emma T." />
            <h3>Emma T.</h3>
            <p>Customer Relations Manager</p>
          </div>
          <div className="team-member">
            <img src="/images/team/michael.jpg" alt="Michael B." />
            <h3>Michael B.</h3>
